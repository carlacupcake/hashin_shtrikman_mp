...
class GeneticString:
    ...
    def get_cost(self):
        ...
        if "carrier-transport" in self.property_docs:
            ...
            Lam0_mat1, Lam0_mat2 = self.values[idx:idx+1]
            ...
            Lam1_mat1, Lam1_mat2 = self.values[idx:idx+1]
            idx += 2
        ...
        if "dielectric" in self.property_docs:
            ...
            Lam2_mat1, Lam2_mat2 = self.values[idx:idx+1]
            idx += 2
            ...
            Lam3_mat1, Lam3_mat2 = self.values[idx:idx+1]
            idx += 2
            ...
            Lam4_mat1, Lam4_mat2 = self.values[idx:idx+1]
            idx += 2
            ...
            Lam5_mat1, Lam5_mat2 = self.values[idx:idx+1]
            idx += 2
        ...
        if "elastic" in self.property_docs:
            ...
            Lam8_mat1, Lam8_mat2 = self.values[idx:idx+1]
            idx += 2
        ...
        if "magnetic" in self.property_docs:
            ...
            Lam9_mat1, Lam9_mat2 = self.values[idx:idx+1]
            idx += 2
            ...
            Lam10_mat1, Lam10_mat2 = self.values[idx:idx+1]
            idx += 2
        ...
        if "piezoelectric" in self.property_docs:
            ...
            # Extract total magnetization normalized volume from genetic string 
            Lam11_mat1, Lam11_mat2 = self.values[idx:idx+1]
            idx += 2
        ...
        des_props = []
        if self.property_docs["carrier-transport"] != []:
            des_props.extend(self.property_docs["carrier-transport"])
        if self.property_docs["dielectric"] != []:
            des_props.extend(self.property_docs["dielectric"])
        if self.property_docs["elastic"] != []:
            des_props.extend(self.property_docs["elastic"])
        if self.property_docs["magnetic"] != []:
            des_props.extend(self.property_docs["magnetic"])
        if self.property_docs["piezoelectric"] != []:
            des_props.extend(self.property_docs["piezoelectric"])
